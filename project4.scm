...
;   Value; gym
;   > (ask me 'say (list 'my 'name 'is (ask me 'name)))
;   Value; At gym ayberk says -- my name is ayberk said-and-heard
;   > (ask me 'say '(hello world!))
;   Value; At gym ayberk says -- hello world! said-and-heard
;   > (ask me 'go 'east)
;   Value; ayberk moves from gym to library 
;          --- the-clock Tick 0 --- 
;          You are in library 
...
;   > (ask me 'take (thing-named 'engineering-book))
;   Value; At library ayberk says -- I take engineering-book from library 
;   > (ask me 'toss 'engineering-book)
;   Value; At library ayberk says -- I drop engineering-book at library 
;   > (ask me 'die)
;   Value; At library ayberk says -- SHREEEEK!  I, uh, suddenly feel very faint... 
;          An earth-shattering, soul-piercing scream is heard... 
;          ayberk moves from library to heaven game-over-for-you-dude  	  	   	 
...
;       ayberk moves from great-court to graduation-stage 
;       --- the-clock Tick 0 --- 
...
;      At deans-office ayberk says -- I take transcript from deans-office 
;    > (ask me 'go 'down)

;      ayberk moves from deans-office to eng-z21 
;      --- the-clock Tick 0 --- 
;      You are in eng-z21 
...
;      ayberk moves from eng-z21 to eng-building 
;      At eng-building ayberk says -- Hi alyssa-p-hacker 
...
;      ayberk moves from eng-building to sci-building 
;      At sci-building ayberk says -- Hi prof-yuret 
...
;      ayberk moves from sci-building to sos-building 
;      At sos-building ayberk says -- Hi ben-bitdiddle prof-yuret 
;      An earth-shattering, soul-piercing scream is heard... 
...
;      ayberk moves from sos-building to cas-building 
;      At cas-building ayberk says -- Hi prof-yuret 
...
;      ayberk moves from cas-building to great-court 
;      An earth-shattering, soul-piercing scream is heard... 
;      At great-court suzy says -- Hi ayberk 
;      At great-court suzy says -- Prepare to suffer, ayberk ! 
;      At great-court ayberk says -- Ouch! 3 hits is more than I want! 
;      At great-court ayberk says -- SHREEEEK!  I, uh, suddenly feel very faint... 
;      At great-court ayberk says -- I lose transcript 
;      At great-court ayberk says -- Yaaaah! I am upset! 
;      An earth-shattering, soul-piercing scream is heard... 
...
;      At eng-z21 ayberk says -- I take problem-set from eng-z21 
;    > (Ask me 'go 'out)
...
;      An earth-shattering, soul-piercing scream is heard... 
;      alyssa-p-hacker moves from eng-building to soccer-field 
;      At eng-building alyssa-p-hacker says -- Hi ayberk 
;      --- the-clock Tick 7 --- 
;      You are in eng-building 
...
;      At sci-building ayberk says -- Hi prof-yuret 
;      An earth-shattering, soul-piercing scream is heard... 
;      At sci-building ayberk says -- Ouch! 1 hits is more than I want! 
...
;      ayberk moves from sci-building to eng-building 
;      At eng-building ayberk says -- Hi alyssa-p-hacker prof-yuret 
;      At eng-building ayberk says -- Ouch! 1 hits is more than I want! 
...
;      ayberk moves from sci-building to sos-building 
;      At sos-building alyssa-p-hacker says -- Hi ayberk 
...
;      ayberk moves from sos-building to cas-building 
;      An earth-shattering, soul-piercing scream is heard... 
;      At cas-building ayberk says -- Ouch! 2 hits is more than I want! 
;      At cas-building ayberk says -- SHREEEEK!  I, uh, suddenly feel very faint... 
;      At cas-building ayberk says -- I lose problem-set 
;      At cas-building ayberk says -- Yaaaah! I am upset! 
;      An earth-shattering, soul-piercing scream is heard... 
...
;      ayberk moves from deans-office to eng-z21 
;      An earth-shattering, soul-piercing scream is heard... 
;      At eng-z21 ayberk says -- Ouch! 2 hits is more than I want! 
;      At eng-z21 prof-yuret says -- Hi ayberk 
;      --- the-clock Tick 13 --- 
;      You are in eng-z21 
;      You are not holding anything. 
;      There is no stuff in the room. 
...
;      ayberk moves from eng-z21 to eng-auditorium 
;      An earth-shattering, soul-piercing scream is heard... 
;      --- the-clock Tick 14 --- 
...
;      ayberk moves from eng-auditorium to eng-z21 
;      At eng-z21 prof-yuret says -- Hi ayberk 
;      --- the-clock Tick 15 --- 
;      You are in eng-z21 
;      You are not holding anything. 
...
;      ayberk moves from eng-z21 to deans-office 
;      An earth-shattering, soul-piercing scream is heard... 
;      --- the-clock Tick 16 --- 
;      You are in deans-office 
;      You are not holding anything. 
...
;      ayberk moves from cas-building to great-court 
;      An earth-shattering, soul-piercing scream is heard... 
;      At great-court alyssa-p-hacker says -- Hi ayberk 
;      --- the-clock Tick 22 --- 
;      You are in great-court 
;      You are not holding anything. 
...
;      ayberk moves from great-court to student-center 
;      At student-center ayberk says -- Hi lambda-man 
;      An earth-shattering, soul-piercing scream is heard... 
;      An earth-shattering, soul-piercing scream is heard... 
;      --- the-clock Tick 23 --- 
...
;      At student-center ayberk says -- I take profiterol from student-center 
;    > (ask me 'go 'in)

;      ayberk moves from student-center to suzy-cafe 
;      At suzy-cafe ayberk says -- Hi cici lambda-man ben-bitdiddle 
...
;      ayberk moves from suzy-cafe to cici-bufe 
;      An earth-shattering, soul-piercing scream is heard... 
;      An earth-shattering, soul-piercing scream is heard... 
;      --- the-clock Tick 25 --- 
...
;      ayberk moves from cici-bufe to migros 
;      --- the-clock Tick 26 --- 
;      You are in migros 
;      You are holding: profiterol 
;      There is no stuff in the room. 
...
;      ayberk moves from migros to cici-bufe 
;      At cici-bufe ayberk says -- Hi cici 
;      At cici-bufe cici says -- Prepare to suffer, aybayberkuke ! 
;      At cici-bufe ayberk says -- Ouch! 1 hits is more than I want! 
;      At cici-bufe ayberk says -- SHREEEEK!  I, uh, suddenly feel very faint... 
;      At cici-bufe ayberk says -- I lose profiterol 
;      At cici-bufe ayberk says -- Yaaaah! I am upset! 
;      An earth-shattering, soul-piercing scream is heard... 
;      ayberk moves from cici-bufe to heaven 
;      At heaven ayberk says -- Hi ben-bitdiddle comp200-student lambda-man 
...
;     At great-court ayberk says -- I take inflatable-lambda from great-court 
...
;     At great-court ayberk says -- I hitted  comp200-student  with  inflatable-lambda  ! said-and-heard  	  	   	 
;   > (ask me 'look-around)
...
;     At sci-building ayberk says -- I hitted  ben-bitdiddle  with  chair-of-the-faculty  ! said-and-heard
;   > (ask (thing-named 'chair-of-the-faculty) 'hit me (thing-named 'ben-bitdiddle))
...
;       At eng-b30 ayberk says -- Ouch! 2 hits is more than I want! 
;       At eng-b30 a bomb  c4  causes  (ayberk)  suffer and even die. destroyed
;     > (ask me 'look-around)
...
;;    	  	   	 
;     ...
;     ayberk moves from great-court to cas-building 
